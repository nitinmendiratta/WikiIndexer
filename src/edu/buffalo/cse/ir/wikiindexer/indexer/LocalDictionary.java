...
/**
 * @author Nitin 
 * This class represents a subclass of a Dictionary class that is local to a single thread. 
 * All methods in this class are assumed thread safe for the same reason.
 */
